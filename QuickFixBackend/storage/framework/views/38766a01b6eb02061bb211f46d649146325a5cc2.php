...
<table class="table table-striped mt-4 table-bordered">
    ...
    <tbody>
        <tr>
            <th scope="row"><?php echo e($order->shop?->translation?->title); ?></th>
            <td><?php echo e($order->shop?->tax); ?></td>
            <td><?php echo e(number_format($order->rate_total_tax, 2)); ?></td>
        </tr>
    </tbody>
</table>
<table class="table table-striped table-bordered">
    ...
    <tr>
        <th scope="row">
            ...
            <?php echo e(number_format(($order->rate_total_price - $order->rate_total_tax), 2)); ?>
        ...
        <td>
            ...
            <?php echo e(number_format($order->rate_delivery_fee, 2)); ?>
        ...
        <td>
            ...
            <?php echo e(number_format($order->rate_total_price, 2)); ?>
        ...
        <td>
            ...
            <?php echo e(number_format($order->rate_coupon_price, 2)); ?>
...
<?php /**PATH /Users/mac/Documents/softwares/work/QuickFix/QuickFixBackend/resources/views/order-invoice.blade.php ENDPATH**/ ?>